...
export LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libtcmalloc_minimal.so.4:/opt/silo/lib/libnofadvise.so:/usr/lib/x86_64-linux-gnu/libeatmydata.so
export CACHEDIR=/mnt/wk0/kvcache
mkdir -p $CACHEDIR
for p in 15 30 60 120; do
	./mlpstorage closed kvcache run --hosts 10.100.200.46 10.100.200.47 10.100.200.48 10.100.200.49 10.100.200.50 10.100.200.51 10.100.200.52 10.100.200.53 10.100.200.26 10.100.200.27 10.100.200.28 10.100.200.29 10.100.200.30 10.100.200.31 10.100.200.32 --exec-type=mpi --mpi-params="-x LD_PRELOAD=$LD_PRELOAD" --results-dir=/mnt/mlperf_results/ --systemname=hickory --allow-run-as-root --cache-dir $CACHEDIR -np $p;
	for host in 10.100.200.46 10.100.200.47 10.100.200.48 10.100.200.49 10.100.200.50 10.100.200.51 10.100.200.52 10.100.200.53 10.100.200.26 10.100.200.27 10.100.200.28 10.100.200.29 10.100.200.30 10.100.200.31 10.100.200.32; do
		ssh -i /home/fgpu/.ssh/weka_id_rsa fgpu@$host sudo pkill -9 mpi;
	done;
done
