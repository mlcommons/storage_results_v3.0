...
def write_datagen_manifest(
    ...
    manifest = {
        ...
        "model": model,
        "num_files_train": int(dataset_params["num_files_train"]),
        "num_samples_per_file": int(dataset_params["num_samples_per_file"]),
        "record_length_bytes": int(dataset_params["record_length_bytes"]),
